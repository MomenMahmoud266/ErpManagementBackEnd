...
public class ProductRepository(ErpManagementDbContext context, ICurrentTenant currentTenant)
    : BaseRepository<Product>(context, currentTenant), IProductRepository
{
}