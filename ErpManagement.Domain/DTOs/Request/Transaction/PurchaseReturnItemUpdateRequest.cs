// ErpManagement.Domain\DTOs\Request\Transactions\PurchaseReturnUpdateRequest.cs
...
public class PurchaseReturnItemUpdateRequest
{
...
public class PurchaseReturnUpdateRequest
{
    ...
    public List<PurchaseReturnItemUpdateRequest> Items { get; set; } = new();
}